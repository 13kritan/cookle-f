...
export default function Search({setSearchPage}) {
  ...
  return (
    <>
    <div className="relative w-full min-h-[25vh] overflow-hidden bg-slate-500">
      ...
      <div className='w-2/3 h-full absolute right-0 py-4 flex flex-col items-center gap-1'
        style={{
      ...
      >
        <h1 className="flex flex-col text-white font-extrabold text-left text-4xl tracking-wide w-1/2">
          Culinary Journey
          <span>Awaits</span>
        </h1>
